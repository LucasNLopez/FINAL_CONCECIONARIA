...
def ventana_inicio():
    ...
    ventana_principal.config(relief="groove",bg="#5458C2")
    ventana_principal.iconbitmap("auto.ico")
    ventana_principal.geometry("800x550")#DIMENSIONES DE LA VENTANA
    ventana_principal.title("Panel")#TITULO DE LA VENTANA
    ...
    titlelabel=Label(ventana_principal, text="CONCESIONARIA",font=title_font)
    titlelabel.config(bg="#5458C2")
    titlelabel.pack() 
    Button(text="Acceder", height="2", width="30", bg="#5458C2", command=login).pack() #BOTÓN "Acceder"
    #Label(text="").pack()
    Button(text="Registrarse", height="2", width="30", bg="#5458C2", command=registro).pack() #BOTÓN "Registrarse".
    #Label(text="").pack()
